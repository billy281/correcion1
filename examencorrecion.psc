...
Funcion pruebadeescritorio()
	...
	//r = 19 mod 15
	//El resultado es 4.
	//La condicion r = 0 es falsa ya que r no es igual a cero.
	//Actualizacion de variables:
	//n toma el valor de m: n = 19
	//m toma el valor de r: m = 4
	//Segunda iteraci?n del bucle mientras:
	//La condicion r <> 0 sigue siendo verdadera.
	//C?lculo del resto:
	//r = m mod n
	//r = 4 mod 19
	//El resultado es 4.
	//La condicion r = 0 es falsa.
	//Actualizacion de variables:	
	//n toma el valor de m: n = 4
	//m toma el valor de r: m = 4
	//Tercera iteracion del bucle mientras:
	//La condici?n r <> 0 sigue siendo verdadera.
	//C?lculo del resto:
	//r = m mod n
	//r = 4 mod 4
	//El resultado es 0.
	//La condicion r = 0 es verdadera.
	//Imprime el resultado: "m = 4, n = 4".FinFuncion
FinFuncion
funcion edades()
	//elaborar un algoritmo tal, que dado un nombre y la edad en a?os. 
...
Funcion ultimo()
	...
	Escribir "Ingrese la expresion matem?tica: "
    Leer expresion
    cantidad_de_Digitos=0;cantidad_Operadores=0;i= 0
    
    Mientras i <= Longitud(expresion) Hacer
        car = Subcadena(expresion, i, i)
        //la variable car se utiliza para almacenar cada car?cter de la expresion matematica mientras se recorre la cadena
	...
	Si cantidadDigitos > cantidadOperadores entonces
		Escribir "Hay mas digitos que operadores y parentesis juntos"
	Sino 
		Escribir "Hay menos digitos que operadores y parentesis juntos"
	Fin Si
FinFuncion
